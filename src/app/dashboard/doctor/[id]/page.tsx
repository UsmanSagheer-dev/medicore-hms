      ...
      <div className="max-w-7xl mx-auto w-full mb-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-gray-600">Welcome back, <span className="text-blue-600 font-semibold">{doctorName}</span></p>
          </div>
          ...
          <div className="space-y-6 overflow-y-auto pr-1">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-2">
                <button className="w-full p-4 bg-gray-50 hover:bg-blue-600 hover:text-white rounded-xl text-left transition-all font-semibold flex items-center justify-between group">
